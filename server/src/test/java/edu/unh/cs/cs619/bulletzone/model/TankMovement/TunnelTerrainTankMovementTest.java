 ...
 */
public class TunnelTerrainTankMovementTest {
    ...
    public void Miner_TunnelFromLowLayertoHighLayer() {
        ...
        assertInstanceOf(HillsTerrain.class,tank.getParent().getNeighbor(Direction.Down).getTerrain());
    }


    @Test
    public void Miner_TunnelFromHigherLayertoLowLayer() {
        tank.setDirection(Direction.Up);
        ...
        // asser that the surrounding terrain is the correct one for that layer. verifying tunnel success
        assertInstanceOf(MeadowTerrain.class,tank.getParent().getNeighbor(Direction.Down).getTerrain());
    }
